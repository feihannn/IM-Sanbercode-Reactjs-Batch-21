...
const DaftarBuku = () => {  
  ...
  const [input, setInput]  =  useState({id: null, title: "", description: "", review: "", release_year: "2020", totalPage: 0, price: 0 })
...
const handleDelete = (event) => {
  ...
  const handleEdit = (event) =>{
    ...
    .then(res => {
      ...
      setInput({id: idDataBuku,title: dataBuku.title, description: dataBuku.description, review: dataBuku.review,release_year: dataBuku.release_year,totalPage:dataBuku.totalPage,price:dataBuku.price })
    })
  ...
  const handleSubmit = (event) =>{
    ...
    if (input.id === null){        
      axios.post(`http://backendexample.sanbercloud.com/api/books`, {title,description,review,release_year,totalPage,price})
      .then(res => {
          setdaftarBuku([
            ...daftarBuku, 
            { id: res.data.id, 
      ...
      axios.put(`http://backendexample.sanbercloud.com/api/books/${input.id}`, {title,description,review,release_year,totalPage,price})
      .then(() => {
    ...
    setInput({id: null, title: "", description: "", review: "", release_year: "", totalPage: 0, price: 0 })
